...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder = when (layout) {
        Layout.GRID -> inflate(parent, R.layout.grid_list_item)
        else -> inflate(parent, R.layout.vertical_horizontal_list_item)
    }
    ...
    private fun inflate(parent: ViewGroup, viewId: Int): DogCardViewHolder {
